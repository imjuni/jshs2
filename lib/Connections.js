...
module.exports = function () {
  ...
  function Connection (options) {
    ...
    if (!options.auth || Connection.prototype.authMechanisms.indexOf(options.auth) < 0) {
  ...
  Connection.prototype.authMechanisms = ['NOSASL', 'PLAIN'];
  ...
  Connection.prototype.cursor = function () {
  ...
  Connection.prototype.connect = function (callback) {
    ...
    self.connection = thrift.createConnection(self._options.host, self._options.port, connOptions);
    ...
    if (self._options.auth === 'NOSASL') {
      req.username = '1002099';
      req.password = '';
    } else if (self._options.auth === 'PLAIN') {
      req.username = self._options.user;
      req.password = self._options.pw;
    }
