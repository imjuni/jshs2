(function () {
  ...
  HS2Util.thriftPatch = function () {
    ...
    thrift.createSASLConnection = function (host, port, options) {
    ...
    TCLIServiceTypes.THandleIdentifier.prototype.write = function(output) {
      ...
      if (this.guid !== null && this.guid !== undefined) {
        output.writeFieldBegin('guid', thrift.Thrift.Type.STRING, 1);
        output.writeBinary(this.guid);
        output.writeFieldEnd();
      }
      if (this.secret !== null && this.secret !== undefined) {
        output.writeFieldBegin('secret', thrift.Thrift.Type.STRING, 2);
