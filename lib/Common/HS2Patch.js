(function () {
  ...
  function HS2Patch () {
    ...
    function patch () {
       ...
       *
       */
      thrift.TSaslClientTransport = require('./../transport/TSaslClientTransport');

      if (!thrift.createSASLConnection) {
  ...
  HS2Patch.prototype.readEx = readEx;
  HS2Patch.prototype.writeEx = writeEx;
  HS2Patch.prototype.createSASLConnection = createSASLConnection;

  module.exports = new HS2Patch();
})();