(function () {
  ...
  HS2Util.prototype.pSleep = function pSleep (ms) {
    return new Promise(function (resolve) {
      setTimeout(function () { resolve(); }, ms);
    });
  };

  HS2Util.prototype.cSleep = function cSleep (ms, callback) {
    setTimeout(function () {
      callback();
    }, ms);
  };
  ...
  HS2Util.prototype.isFinish = function isFinish (cursor, status) {
