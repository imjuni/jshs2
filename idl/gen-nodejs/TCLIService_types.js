  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem52 = null;
          elem52 = new ttypes.TBoolValue();
          elem52.read(input);
          this.boolColumn.push(elem52);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem59 = null;
          elem59 = new ttypes.TByteValue();
          elem59.read(input);
          this.byteColumn.push(elem59);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem66 = null;
          elem66 = new ttypes.TI16Value();
          elem66.read(input);
          this.i16Column.push(elem66);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem73 = null;
          elem73 = new ttypes.TI32Value();
          elem73.read(input);
          this.i32Column.push(elem73);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem80 = null;
          elem80 = new ttypes.TI64Value();
          elem80.read(input);
          this.i64Column.push(elem80);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem87 = null;
          elem87 = new ttypes.TDoubleValue();
          elem87.read(input);
          this.doubleColumn.push(elem87);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem94 = null;
          elem94 = new ttypes.TStringValue();
          elem94.read(input);
          this.stringColumn.push(elem94);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TColumn.prototype.write = function(output) {
  ...
  if (this.boolColumn !== null && this.boolColumn !== undefined) {
    ...
    for (var iter95 in this.boolColumn)
    {
      if (this.boolColumn.hasOwnProperty(iter95))
      {
        iter95 = this.boolColumn[iter95];
        iter95.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.byteColumn !== null && this.byteColumn !== undefined) {
    ...
    for (var iter96 in this.byteColumn)
    {
      if (this.byteColumn.hasOwnProperty(iter96))
      {
        iter96 = this.byteColumn[iter96];
        iter96.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.i16Column !== null && this.i16Column !== undefined) {
    ...
    for (var iter97 in this.i16Column)
    {
      if (this.i16Column.hasOwnProperty(iter97))
      {
        iter97 = this.i16Column[iter97];
        iter97.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.i32Column !== null && this.i32Column !== undefined) {
    ...
    for (var iter98 in this.i32Column)
    {
      if (this.i32Column.hasOwnProperty(iter98))
      {
        iter98 = this.i32Column[iter98];
        iter98.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.i64Column !== null && this.i64Column !== undefined) {
    ...
    for (var iter99 in this.i64Column)
    {
      if (this.i64Column.hasOwnProperty(iter99))
      {
        iter99 = this.i64Column[iter99];
        iter99.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.doubleColumn !== null && this.doubleColumn !== undefined) {
    ...
    for (var iter100 in this.doubleColumn)
    {
      if (this.doubleColumn.hasOwnProperty(iter100))
      {
        iter100 = this.doubleColumn[iter100];
  ...
  if (this.stringColumn !== null && this.stringColumn !== undefined) {
    ...
    for (var iter101 in this.stringColumn)
    {
      if (this.stringColumn.hasOwnProperty(iter101))
      {
        iter101 = this.stringColumn[iter101];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem108 = null;
          elem108 = new ttypes.TColumnValue();
          elem108.read(input);
          this.colVals.push(elem108);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TRow.prototype.write = function(output) {
  ...
  if (this.colVals !== null && this.colVals !== undefined) {
    ...
    for (var iter109 in this.colVals)
    {
      if (this.colVals.hasOwnProperty(iter109))
      {
        iter109 = this.colVals[iter109];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem116 = null;
          elem116 = new ttypes.TRow();
          elem116.read(input);
          this.rows.push(elem116);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        this.columns = [];
        var _etype120 = 0;
        _rtmp3121 = input.readListBegin();
        _etype120 = _rtmp3121.etype;
        _size117 = _rtmp3121.size;
        for (var _i122 = 0; _i122 < _size117; ++_i122)
        {
          var elem123 = null;
          elem123 = new ttypes.TColumn();
          elem123.read(input);
          this.columns.push(elem123);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TRowSet.prototype.write = function(output) {
  ...
  if (this.rows !== null && this.rows !== undefined) {
    ...
    for (var iter124 in this.rows)
    {
      if (this.rows.hasOwnProperty(iter124))
      {
        iter124 = this.rows[iter124];
  ...
  if (this.columns !== null && this.columns !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.columns.length);
    for (var iter125 in this.columns)
    {
      if (this.columns.hasOwnProperty(iter125))
      {
        iter125 = this.columns[iter125];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i131 = 0; _i131 < _size126; ++_i131)
        {
          ...
          this.infoMessages.push(elem132);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TStatus.prototype.write = function(output) {
  ...
  if (this.infoMessages !== null && this.infoMessages !== undefined) {
    ...
    for (var iter133 in this.infoMessages)
    {
      if (this.infoMessages.hasOwnProperty(iter133))
      {
        iter133 = this.infoMessages[iter133];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i149 = 0; _i149 < _size144; ++_i149)
        {
          ...
          this.configuration[key150] = val151;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TOpenSessionResp.prototype.write = function(output) {
  ...
  if (this.configuration !== null && this.configuration !== undefined) {
    output.writeFieldBegin('configuration', Thrift.Type.MAP, 4);
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.configuration));
    for (var kiter152 in this.configuration)
    {
      if (this.configuration.hasOwnProperty(kiter152))
      {
        var viter153 = this.configuration[kiter152];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i159 = 0; _i159 < _size154; ++_i159)
        {
          ...
          this.confOverlay[key160] = val161;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TExecuteStatementReq.prototype.write = function(output) {
  ...
  if (this.confOverlay !== null && this.confOverlay !== undefined) {
    ...
    for (var kiter162 in this.confOverlay)
    {
      if (this.confOverlay.hasOwnProperty(kiter162))
      {
        var viter163 = this.confOverlay[kiter162];
...
TGetTablesReq.prototype.write = function(output) {
  ...
  if (this.tableTypes !== null && this.tableTypes !== undefined) {
    ...
    for (var iter171 in this.tableTypes)
    {
      if (this.tableTypes.hasOwnProperty(iter171))
      {
        iter171 = this.tableTypes[iter171];
